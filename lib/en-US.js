...
module.exports = {
  ...
  messages: {
    ...
    'app.home.components-explain': 'Based on the Ant Design language, we have provided a suite of out-of-the-box with high quality for developing and serving enterprise background applications, including the official React UI library and Angular, Vue implementations',
    ...
    'app.docs.components.icon.pic-searcher.upload-text': 'Click or drag or paste file to this area to upload',
    'app.docs.components.icon.pic-searcher.upload-hint': 'We will find the most matching icon based on the image',
